...
public class ValidateMoves {
    ...
    // // to will always be greater then from
    // if (from.getRank() >= to.getRank()) {
    // throw new IllegalMove("Cannot Move downwards or parallel !!");
    // }

    // // cannot move pawn more then 2 squares
    // if (to.getRank() - from.getRank() > 2) {
    // throw new IllegalMove("Cannot move that many steps !!");
    // }

    // // if moving two square and it is not first move of the pawn
    // if (to.getRank() - from.getRank() == 2 && from.getRank() != 2) {
    // throw new IllegalMove("Cannot move that many square !!");
    // }
    ...
    // // if moving two square checking if there is something in the middle
    // if (to.getRank() - from.getRank() == 2) {
    // if (board.getPiece(new Positon(from.getRank() + 1, from.getIndex())) != null)
    // {
    // throw new IllegalMove("Something is in the middle ! cannot move !!");
    // }
    // }
    ...
    // // if not moving straight : must be a capture or en passant
    // if (board.getPiece(to) == null
    // && board.getPiece(new Positon(to.getRank() - 1, to.getIndex())) == null) {
    // throw new IllegalMove("Illegal move !!");
    // }

    // // if there is no black piece then pawn cannot go diagonally
    // if (board.getPiece(to) != null) {
    // if (board.getPiece(to).getColor() != COLORS.BLACK) {
    // throw new IllegalMove("Cannot capture !!");
    // }
    // } else {
    // // if its en passent then pawn must be on fifth rank
    // if (from.getRank() != 5
    // || board.getPiece(new Positon(from.getRank(), to.getIndex())).getColor() !=
    // COLORS.BLACK
    // || board.getPiece(new Positon(from.getRank(), to.getIndex())).getName() !=
    // PIECES.PAWN) {
    // throw new IllegalMove("En passent is only possible on fifth rank");
    // }
    // }
    // }
    // if (from.getRank() == 5 && board.getPiece(to) == null &&
    // Math.abs(from.getIndex() - to.getIndex()) == 1
    // && board.getPiece(new Positon(from.getRank(), to.getIndex())).getColor() ==
    // COLORS.BLACK
    // && board.getPiece(new Positon(from.getRank(), to.getIndex())).getName() ==
    // PIECES.PAWN) {
    // board.getMap().get(from.getRank()).get(to.getIndex()).setPiece(null);
    // }
    // } else {
    // // rank validations

    // // from will always be greater then to : done
    // if (from.getRank() <= to.getRank()) {
    // throw new IllegalMove("from will always be greater then to");
    // }

    // // cannot move pawn more then 2 squares : done
    // if (from.getRank() - to.getRank() > 2) {
    // throw new IllegalMove("cannot move pawn more then 2 squares");
    // }

    // // if moving two square and it is not first move of the pawn : done
    // if (from.getRank() - to.getRank() == 2 && from.getRank() != 7) {
    // throw new IllegalMove("if moving two square and it is not first move of the
    // pawn");
    // }
    ...
    // if (from.getIndex() == to.getIndex()) { // done
    // if (board.getPiece(to) != null) { // done
    // throw new IllegalMove("if moving straight : no pieces should on that
    // square");
    // }
    ...
    // if (board.getPiece(new Positon(from.getRank() - 1, from.getIndex())) != null)
    // {
    // throw new IllegalMove("if moving two square checking if there is something in
    // the middle");
    // }
    // }
    ...
    // throw new IllegalMove("if not moving straight : must be a capture or en
    // passant");
    // } // done

    // // if there is no white piece then pawn cannot go diagonally
    // if (board.getPiece(to) != null) {
    // if (board.getPiece(to).getColor() != COLORS.WHITE) {
    // throw new IllegalMove("if there is no white piece then pawn cannot go
    // diagonally");
    // }
    // } else {
    // // if its en passent then pawn must be on fifth rank
    ...
    // || board.getPiece(new Positon(from.getRank(), to.getIndex())).getName() !=
    // PIECES.PAWN) {
    // throw new IllegalMove("if its en passent then pawn must be on fifth rank");
    // }
    // }
    // }

    // if (from.getRank() == 4 && board.getPiece(to) == null &&
    // Math.abs(from.getIndex() - to.getIndex()) == 1
    // && board.getPiece(new Positon(from.getRank(), to.getIndex())).getColor() ==
    // COLORS.WHITE
    // && board.getPiece(new Positon(from.getRank(), to.getIndex())).getName() ==
